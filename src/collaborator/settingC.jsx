...
export default function AccountSetting() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(`${process.env.REACT_APP_BKD_URI}/api/v3/collaboratorPersonalInfo/${id}`, formData);
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex' }}>
        <Cside />
        <div style={{ flex: 1, marginTop: '2%', margin: '1%', marginLeft: '2%' }} className='collabcreateaccount'>
          <Box sx={{ flexGrow: 1 }}>
            <Grid container>
          ...
          <div className={styles.fileImg}>
            <input
              ...
              style={{ display: 'none' }}
            />
            <div onClick={handleAvatarClick} style={{ cursor: 'pointer', marginLeft: "8%", marginTop: "4%" }}>
              <Avatar
                alt='user image'
                src={user.image}
