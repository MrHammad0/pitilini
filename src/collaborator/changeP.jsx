...
const Signup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_BKD_URI}/api/v3/change/collaborator/password/${userId}`, user, {
        headers: {
    ...
    <>
        ...
        <Grid container>
          <Grid item xs={12} md={6} lg={6}>
            <div className={styles.flexinfo}>
              ...
              <div className={styles.space}>
                <h4>
                  <Link to="/collaborator/settingC" style={{ color: "black", textDecoration: "none" }}>
                    Personal Info
                  </Link>
                </h4>
              </div>
          ...
          <Grid item xs={12} md={6} lg={6}>
            <div className={styles.flexinfo}>
              ...
              <div className={styles.space}>
                <Link to="/collaborator/changePassword" style={{ color: "black", textDecoration: "none" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: '5%' }}>
        ...
        <form onSubmit={submitHandler}>
          ...
          <Input type="password" placeholder="Old Password" name="oldPassword" value={user.oldPassword} onChange={changeValue} style={{ width: "50%", margin: "2%" }} />
          ...
          <div style={{ marginTop: "4%" }}>
            <SvgButton className={styles.btnSubmit} type="submit">Submit</SvgButton>
          </div>
        </form>
      </div>
    </>
