...
//       try {
//         const response = await axios.get(`${process.env.REACT_APP_BKD_URI}/api/v3/get/mlc/USA/ship`);
...
//     const fetchUserData = async () => {
//       try {
//         const response = await axios.get(`${process.env.REACT_APP_BKD_URI}/api/v3/get/mlc/Europe/ship`);
...
//           <div>
//             <h4>MLC USA Shipment Details</h4>
...
//                     <StyledTableCell>RecipientAddress</StyledTableCell>
//                     <StyledTableCell>RouteNumber</StyledTableCell>
//                     <StyledTableCell>SwiftCode</StyledTableCell>
//                   </TableRow>
//                 </TableHead>
//                 <TableBody>
//                   {users.map((user) => (
...
//           <br/>
//           <div>
//             <h4>MLC Europe Shipment Details</h4>
//             <TableContainer component={Paper}>
//               <Table sx={{ minWidth: 700 }} aria-label="customized table">
//                 <TableHead>
//                   <TableRow>
...
export default function AdminDash() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_BKD_URI}/api/v3/get/CUP/USA/ship`);
        setUsers(response.data);
        console.log(response);
      } catch (error) {
        console.log("Error fetching user data:", error);
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_BKD_URI}/api/v3/get/CUP/Europe/ship`);
        setMlcEurope(response.data);
        console.log(response);
      } catch (error) {
        console.log("Error fetching user data:", error);
    ...
    <>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div className='userDetails'>
          ...
          {selectedRegion === 'USA' && (
            <div>
              <h4 style={{ textAlign: 'center' }}>CUP USA Shipment Details</h4>
              <TableContainer component={Paper}>
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                  <TableHead>
                    <TableRow>
          ...
          {selectedRegion === 'Europe' && (
            <div>
              <h4 style={{ textAlign: 'center' }}>CUP Europe Shipment Details</h4>
              <TableContainer component={Paper}>
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                  <TableHead>
                    <TableRow>
